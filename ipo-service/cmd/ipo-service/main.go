...
import (
	...
	"github.com/qubic/qubic-aggregation/ipo-service/clients"
	"github.com/qubic/qubic-aggregation/ipo-service/domain"
	"github.com/qubic/qubic-aggregation/ipo-service/grpc"
...
const confPrefix = "QUBIC_AGGREGATION_IPO_SERVICE"
...
func run(logger *zap.SugaredLogger) error {
	...
	grpcService := grpc.NewService(logger.Named("grpc"), bidService)
