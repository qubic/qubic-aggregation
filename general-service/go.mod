...
require (
	...
	github.com/qubic/archive-query-service/v2 v2.0.0-20260514051434-dfc81b64fab5
	github.com/qubic/go-data-publisher/status-service v1.5.0
...
require github.com/qubic/go-node-connector/v2 v2.0.0
