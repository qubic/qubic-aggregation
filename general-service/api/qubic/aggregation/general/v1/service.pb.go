...
const file_qubic_aggregation_general_v1_service_proto_rawDesc = "" +
	"\n" +
	"*qubic/aggregation/general/v1/service.proto\x12\x1cqubic.aggregation.general.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a+qubic/aggregation/general/v1/messages.proto2\xb6\b\n" +
	...
	"\x13GetIdentitiesAssets\x128.qubic.aggregation.general.v1.GetIdentitiesAssetsRequest\x1a9.qubic.aggregation.general.v1.GetIdentitiesAssetsResponse\"\xe4\x01\xbaG\xb9\x01\x12,Get asset balances for a list of identities.\x1a\x88\x01Allows for requesting the owned and possessed asset balances (tokens and smart contract shares) for a number of Qubic wallet identities.\x82\xd3\xe4\x93\x02!:\x01*b\x06assets\"\x14/getIdentitiesAssetsB\xeb\x01\xbaG\xa4\x01\x12W\n" +
...
var file_qubic_aggregation_general_v1_service_proto_goTypes = []any{
	...
	(*GetIdentitiesAssetsResponse)(nil),   // 5: qubic.aggregation.general.v1.GetIdentitiesAssetsResponse
}
var file_qubic_aggregation_general_v1_service_proto_depIdxs = []int32{
	...
	5, // 5: qubic.aggregation.general.v1.AggregationGeneralService.GetIdentitiesAssets:output_type -> qubic.aggregation.general.v1.GetIdentitiesAssetsResponse
